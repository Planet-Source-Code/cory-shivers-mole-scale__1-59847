...
Case "1"
frmmole.txtelm.Text = frmmole.txtelm.Text + "ב"
Case "2"
frmmole.txtelm.Text = frmmole.txtelm.Text + "ג"
Case "3"
frmmole.txtelm.Text = frmmole.txtelm.Text + "ד"
Case "4"
frmmole.txtelm.Text = frmmole.txtelm.Text + "ה"
Case "5"
frmmole.txtelm.Text = frmmole.txtelm.Text + "ו"
Case "6"
frmmole.txtelm.Text = frmmole.txtelm.Text + "ז"
Case "7"
frmmole.txtelm.Text = frmmole.txtelm.Text + "ח"
Case "8"
frmmole.txtelm.Text = frmmole.txtelm.Text + "ט"
Case "9"
frmmole.txtelm.Text = frmmole.txtelm.Text + "י"
Case "10"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בא"
Case "11"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בב"
Case "12"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בג"
Case "13"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בד"
Case "14"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בה"
Case "15"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בו"
Case "16"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בז"
Case "17"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בח"
Case "18"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בט"
Case "19"
frmmole.txtelm.Text = frmmole.txtelm.Text + "בי"
Case "20"
frmmole.txtelm.Text = frmmole.txtelm.Text + "גא"
End Select
End Sub
